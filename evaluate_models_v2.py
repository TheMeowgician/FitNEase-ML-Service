...
Sampled evaluation follows He et al. (2017) protocol: 30 candidates per user
...
NUM_NEGATIVES = 29  # 29 negatives + 1 positive = 30 candidates
...
def sampled_candidates(test_exercise_id, all_exercise_ids, seen_ids, num_neg, seed):
    """Sample 99 random negatives + 1 positive = 30 candidates."""
...
def print_report(rf, cb, cf, hy):
    ...
    print("   Sampled metrics: 30 candidates (He et al. 2017)")
    print("=" * 60)
    ...
    print("  Sampled metrics use 30 candidates (He et al. 2017).")
    print("=" * 60)
    print()
