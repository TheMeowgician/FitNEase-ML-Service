...
Sampled evaluation follows He et al. (2017) protocol: 20 candidates per user
(1 positive + 29 random negatives). This is the standard in RecSys research.
...
NUM_NEGATIVES = 19  # 19 negatives + 1 positive = 20 candidates
...
def evaluate_collaborative(ratings_df):
    ...
    cf_model = ProperCollaborativeFiltering(algorithm='SVD', n_factors=15)
...
def print_report(rf, cb, cf, hy):
    ...
    print("   Sampled metrics: 20 candidates (He et al. 2017)")
    print("=" * 60)
    ...
    print("  Sampled metrics use 20 candidates (He et al. 2017).")
    print("=" * 60)
    print()
