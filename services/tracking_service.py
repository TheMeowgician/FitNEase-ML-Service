...
class TrackingService(BaseService):
    ...
    def get_exercise_ratings(self, user_id: Optional[int] = None, since: Optional[str] = None, limit: Optional[int] = None) -> Optional[List[Dict]]:
        ...
        try:
            ...
            response = self.get('/api/ml-internal/ml-data/exercise-ratings', params=params if params else None)
    ...
    def get_user_exercise_ratings(self, user_id: int) -> Optional[Dict[int, float]]:
        ...
        Endpoint: GET /ml-internal/ml-data/user-ratings/{user_id}
        ...
        """
        try:
            response = self.get(f'/api/ml-internal/ml-data/user-ratings/{user_id}')
    ...
    def get_rating_statistics(self) -> Optional[Dict]:
        ...
        Endpoint: GET /ml-internal/ml-data/rating-stats

        Returns:
            Statistics about rating data: total_ratings, unique_users, unique_exercises, etc.
        """
        try:
            response = self.get('/api/ml-internal/ml-data/rating-stats')
